...
#import "PLRMasterViewController.h"

#import "PLRDetailViewController.h"
#import "LoadFeedData.h"
#import "GoogleAuthenticator.h"

@interface PLRMasterViewController () {
    NSMutableArray *_objects;
}
@end

@implementation PLRMasterViewController
...
- (void)viewDidLoad
{
    ...
    [loadFeed performSelector: @selector(loadData) ];
